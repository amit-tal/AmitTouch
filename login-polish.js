(function(){
  ...
  style.textContent=`
    ...
    @media(max-height:820px){
      #login .logo{width:min(225px,62vw)!important;margin-top:3.8vh!important;max-height:21vh!important}
      #login h1{margin-top:1.6vh!important;font-size:24px!important}
      #login p.subtitle{font-size:13.5px!important;margin-top:6px!important}
      #login .field-wrap{height:52px!important;min-height:52px!important;margin-top:1.9vh!important}
      #login .field-wrap + .field-wrap{margin-top:9px!important}
      #login .primary{height:50px!important;min-height:50px!important;line-height:50px!important;margin-top:1.9vh!important}
      #login .divider{margin-top:1.8vh!important}
      #login .secure{margin-top:1.4vh!important;font-size:11.5px!important}
      #login .auth-link{margin-top:1vh!important;font-size:11.5px!important}
    }
    @media(max-height:700px){
      #login .logo{width:min(205px,58vw)!important;margin-top:2.5vh!important;max-height:19vh!important}
      #login h1{margin-top:1vh!important;font-size:22px!important}
      #login p.subtitle{margin-top:4px!important;font-size:12.5px!important}
      #login .field-wrap{height:48px!important;min-height:48px!important;margin-top:1.2vh!important}
      #login .field-wrap + .field-wrap{margin-top:7px!important}
      #login .primary{height:47px!important;min-height:47px!important;line-height:47px!important;margin-top:1.2vh!important}
