...
function waitForAdminEntry(){let tries=0;const go=()=>{if(typeof window.AMIT_TOUCH_ENTER_ADMIN==='function'){window.AMIT_TOUCH_ENTER_ADMIN();return}if(++tries<80)setTimeout(go,50)};go()}
