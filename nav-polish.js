(function(){
 const BUILD='20260819-bottom-nav-liquid-button-v14';
 ...
 #amitBottomNav .nav-glass-indicator{position:absolute!important;z-index:1!important;top:20px!important;left:0!important;width:58px!important;height:58px!important;border-radius:50%!important;border:1px solid rgba(255,255,255,.88)!important;background:linear-gradient(115deg,rgba(255,255,255,.46) 0%,rgba(250,226,224,.46) 32%,rgba(238,177,173,.38) 68%,rgba(255,239,237,.42) 100%)!important;box-shadow:0 12px 28px rgba(176,105,98,.18),inset 0 1.5px 1px rgba(255,255,255,.95),inset 0 -1px 1px rgba(220,145,140,.16),inset 0 0 22px rgba(255,255,255,.22)!important;backdrop-filter:blur(22px) saturate(155%)!important;-webkit-backdrop-filter:blur(22px) saturate(155%)!important;transform:translate3d(var(--bubble-x,0px),-50%,0)!important;transition:transform .36s cubic-bezier(.22,.8,.24,1)!important;will-change:transform!important;pointer-events:none!important;overflow:hidden!important}
 #amitBottomNav .nav-glass-indicator:before{content:''!important;position:absolute!important;left:10%!important;right:10%!important;top:3px!important;height:44%!important;border-radius:30px 30px 50% 50%!important;background:linear-gradient(180deg,rgba(255,255,255,.48),rgba(255,255,255,.08))!important;pointer-events:none!important}
 #amitBottomNav .nav-glass-indicator:after{content:''!important;position:absolute!important;width:72px!important;height:72px!important;right:-8px!important;top:-38px!important;border-radius:50%!important;background:rgba(246,181,183,.28)!important;filter:blur(14px)!important;pointer-events:none!important}
 ...
 function sync(){
   ...
   if(active&&!nav.hidden){
     ...
     nav.style.setProperty('--bubble-x',`${center-29}px`);
   }
 }
