(function(){
 ...
 const BUILD='20260820-home-appointments-real-data-v7';
 ...
 function card(data,future){
   ...
   el.innerHTML=`${status}<div class="appointment-main"><div class="appointment-service">${data.service||'תור'}</div></div><div class="appointment-date"><div class="appointment-day">${heDay(data.date)}</div><div class="appointment-date-num">${shortDate(data.date)}</div><div class="appointment-time">${data.time||''}</div></div>`;
