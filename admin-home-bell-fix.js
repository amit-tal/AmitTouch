(function(){'use strict';
const ID='admin-home-bell-fix-v2';document.getElementById('admin-home-bell-fix-v1')?.remove();if(document.getElementById(ID))return;const s=document.createElement('style');s.id=ID;s.textContent=`
...
body.admin-session-active .admin-home-canonical .ah-bell-dot{position:absolute!important;top:0!important;right:0!important;width:12px!important;height:12px!important;border-radius:50%!important;background:#f2b0ae!important;border:2px solid #fbf6f0!important;box-sizing:border-box!important;box-shadow:0 1px 4px rgba(99,65,65,.12)!important;z-index:10!important;pointer-events:none!important}
