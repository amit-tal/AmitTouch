(function(){'use strict';
const ID='admin-home-bell-fix-v3';['admin-home-bell-fix-v1','admin-home-bell-fix-v2'].forEach(x=>document.getElementById(x)?.remove());if(document.getElementById(ID))return;const s=document.createElement('style');s.id=ID;s.textContent=`
