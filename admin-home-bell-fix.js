(function(){'use strict';
const ID='admin-home-bell-fix-v6';['admin-home-bell-fix-v1','admin-home-bell-fix-v2','admin-home-bell-fix-v3','admin-home-bell-fix-v4','admin-home-bell-fix-v5'].forEach(x=>document.getElementById(x)?.remove());if(document.getElementById(ID))return;const s=document.createElement('style');s.id=ID;s.textContent=`
body.admin-session-active .admin-home-canonical .ah-bell{width:56px!important;height:56px!important;overflow:visible!important;position:relative!important}
...
body.admin-session-active .admin-home-canonical .ah-bell-dot{position:absolute!important;top:2px!important;right:10px!important;width:12px!important;height:12px!important;border-radius:50%!important;background:#f2b0ae!important;border:2px solid #fbf6f0!important;box-sizing:border-box!important;box-shadow:0 1px 4px rgba(99,65,65,.12)!important;z-index:10!important;pointer-events:none!important}
