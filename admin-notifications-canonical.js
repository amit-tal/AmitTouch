...
function loadProposalFlow(){window.__AMIT_ADMIN_PROPOSAL_FLOW_V2__=true;loadOnce('script[data-admin-proposal-flow]','/admin-proposal-flow.js?v=20260825-proposal-v5','adminProposalFlow');loadOnce('script[data-admin-reschedule-final]','/admin-reschedule-final.js?v=20260825-final-v1','adminRescheduleFinal')}
loadOnce('script[data-admin-home-bell-fix]','/admin-home-bell-fix.js?v=20260825-bell-v8','adminHomeBellFix');
...
const old=document.querySelector('script[src*="admin-notifications-reschedule-v5.js"]');if(old)old.remove();
const r=document.createElement('script');r.src='/admin-notifications-reschedule-v5.js?v=20260825-reschedule-v11';r.dataset.adminNotificationsReschedule='1';r.async=false;r.onload=()=>{loadOnce('script[data-admin-reschedule-launch-fix]','/admin-reschedule-launch-fix.js?v=20260823-launch-v4','adminRescheduleLaunchFix');loadProposalFlow()};document.body.appendChild(r)
